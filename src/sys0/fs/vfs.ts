...
import { File, FileT, DirEntries, InodeMaintainer, Inode, FileFromT } from '.'
...
export namespace Vfs {
    ...
    export const create = <FB extends Vfile>(
        ...
        return rootInode as Inode<FileFromT<FB['type']>>
    }



    export const traverse = <FT extends FileT = FileT>(
        vfile: Vfile,
        callback: (vfile: Vfile) => void,
        path = ''
    ) => {
