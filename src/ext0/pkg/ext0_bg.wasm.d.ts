...
export function fs_from_raw(a: number, b: number): number;
export function fs_to_raw(a: number, b: number): void;
export function fs_inode_get_offset(a: number): number;
export function fs_inode_to_raw(a: number, b: number, c: number): void;
